...
Fancy.apply(Fancy, {
  ...
  GRID_HEADER_CELL_LEFT_IMAGE_CLS: 'fancy-grid-header-cell-left-image',
  GRID_HEADER_CELL_CONTAINS_LI: 'fancy-grid-header-cell-contains-left-image',
  ...
  GRID_SUB_HEADER_FILTER_CLS: 'fancy-grid-sub-header-filter',
  GRID_SUB_HEADER_FILTER_CONTAINER_CLS: 'fancy-grid-sub-header-filter-container',
  //grid cell
